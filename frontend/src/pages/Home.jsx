  ...
  return (
    <div style={{ 
      ...
      <div style={{
        position: 'fixed',
        inset: 0,
        background: 'rgba(255, 255, 255, 0.45)', // Soften the background for professional contrast
        zIndex: 0,
        pointerEvents: 'none'
      }}></div>
      ...
      <div style={{ 
        ...
        background: 'url("/hero.png") center/80% no-repeat fixed',
        color: '#fff',
        overflow: 'hidden',
        ...
        <div style={{ 
          ...
          <h1 className="fade-in" style={{ 
            ...
            Luminous <span style={{ fontWeight: 300, color: 'var(--primary)' }}>Logic</span> Stays
          </h1>
      ...
      {/* Modern Footer */}
      <footer style={{ borderTop: '1px solid var(--outline-variant)', padding: '4rem 2rem 2rem', background: 'transparent' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <span className="branding-gradient" style={{ fontSize: '1.85rem', fontWeight: 800, letterSpacing: '-0.03em' }}>LuminousLogic</span>
            <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '0.9rem', marginTop: '0.5rem' }}>© 2026 Luminous Logic Inc. All rights reserved.</p>
          </div>
          <div style={{ display: 'flex', gap: '2rem', fontSize: '0.9rem', fontWeight: 600, color: 'rgba(255, 255, 255, 0.85)' }}>
            <span style={{ cursor: 'pointer' }} className="hover-white">Privacy Policy</span>
            <span style={{ cursor: 'pointer' }} className="hover-white">Terms of Service</span>
